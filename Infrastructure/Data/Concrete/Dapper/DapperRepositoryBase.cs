...
namespace Infrastructure.Data.Concrete.Dapper
{
        ...
        where T : BaseEntity, new()
    {
        ...
        public List<T> GetAllByAktif(Expression<Func<T, bool>> filter = null, Expression<Func<T, object>> orderby = null, Sorted sorted = Sorted.ASC, bool Aktif = true, bool Tracking = false, params string[] includelist)
        {
            throw new NotImplementedException();
        }
